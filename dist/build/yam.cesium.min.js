 ...
 * @version v0.2.4
 * (c) 2022 cyam
 * date: 2022/11/16 23:21:16
 * hash: 3880c61f7c17740d575a
 *
 */
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popup_ctn {\r\n    position: absolute;\r\n    z-index: 999;\r\n    background: #fff;\r\n}\r\n\r\n.popup_tip_container {\r\n    width: 40px;\r\n    height: 20px;\r\n    position: absolute;\r\n    left: 50%;\r\n    margin-left: -20px;\r\n    overflow: hidden;\r\n    pointer-events: none;\r\n}\r\n\r\n.popup_tip {\r\n    width: 17px;\r\n    background: #fff;\r\n    height: 17px;\r\n    padding: 1px;\r\n    margin: -10px auto 0;\r\n    -webkit-transform: rotate(45deg);\r\n    -moz-transform: rotate(45deg);\r\n    -ms-transform: rotate(45deg);\r\n    transform: rotate(45deg);\r\n}\r\n\r\n.popup_header_ctn {\r\n    background: #090302;\r\n    color: #fff;\r\n    font-size: 15px;\r\n    padding: 4px;\r\n}\r\n\r\n.popup_content_ctn {\r\n    padding: 15px;\r\n}\r\n\r\n.popup_close_button {\r\n    user-select: auto;\r\n    position: absolute;\r\n    right: 0;\r\n    top: 0;\r\n    color: #fff;\r\n    cursor: pointer;\r\n}\r\n", ""]);
// Exports
/* harmony default export */ __webpack_exports__["Z"] = (___CSS_LOADER_EXPORT___);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Cesium3DTiles": function() { return /* reexport */ Cesium3dTiles; },
  ...
  "Popup": function() { return /* reexport */ popup_Popup; },
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/plugins/popup/popup.css
var popup = __webpack_require__(2629);
;// CONCATENATED MODULE: ./src/plugins/popup/popup.css
...
var popup_update = injectStylesIntoStyleTag_default()(popup/* default */.Z, popup_options);
       ...
       /* harmony default export */ var popup_popup = (popup/* default */.Z && popup/* default.locals */.Z.locals ? popup/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/plugins/popup/Popup.ts



var Popup = /** @class */function () {
  function Popup(viewer, popupOptions) {
    this.a = 0;
    var _this = this;
    _this.viewer = viewer;
    this.renderEvent = _this.viewer.scene.postRender.addEventListener(function () {
      if (_this.pop) {
        var infoboxContainer = document.getElementById(_this.pop.popupsId);
        if (infoboxContainer != null) {
          if (_this.pop.scenePosition) {
            ...
            var windowPosition = new external_Cesium_.Cartesian2();
            external_Cesium_.SceneTransforms.wgs84ToWindowCoordinates(_this.viewer.scene, _this.pop.scenePosition, windowPosition);
            infoboxContainer.style.bottom = canvasHeight - windowPosition.y + _this.pop.popupOptions.offset.y + "px";
   ...
   */
  Popup.prototype.close = function (popId, closeCallback) {
    var _a;
    var _this = this;
    // 移除div
    (_a = document.querySelector("#" + popId)) === null || _a === void 0 ? void 0 : _a.remove();
   ...
   * @returns {*|string}
   */
  Popup.prototype.addPop = function (popupOptions) {
    var _this = this;
    var popId, title, content, position, offset, close, closeCallback;
    ...
    offset = popupOptions.offset ? popupOptions.offset : {
      x: 0,
      y: 0
    };
...
;// CONCATENATED MODULE: ./src/model/Cesium3dTiles.ts




var Cesium3DTiles = /** @class */function () {
  function Cesium3DTiles(viewer) {
    this.viewer = viewer;
  }
  Cesium3DTiles.prototype.add3dTiles = function (params, options) {
    var _this = this;
    if (options === void 0) {
      options = {
        scale: 1,
    ...
    var tileParams = {
      maximumScreenSpaceError: 19.698310613518657,
      maximumNumberOfLoadedTiles: 1000 //最大加载瓦片个数
    };

    lib_PublicMethod.setOptions(tileParams, params);
    tileParams.imageBasedLightingFactor = new external_Cesium_.Cartesian2(1.0, 1.0);
    var tileset = new external_Cesium_.Cesium3DTileset(tileParams);
    var tileId = new Date().getTime();
    ...
    lib_PublicMethod.setOptions(tileset.originParams, options);
    ...
    tileset.style = new external_Cesium_.Cesium3DTileStyle({
      color: options.color
    });
    tileset.readyPromise.then(function (tileset) {
      var positions = [];
      if (options.longitude != null && options.latitude != null) {
        positions = [external_Cesium_.Cartographic.fromDegrees(options.longitude, options.latitude)];
      }
      ...
      if (!options.longitude || !options.latitude) {
        ...
        var coordinate = lib_CesiumMethod.cartesian3ToLngLat(tileset.boundingSphere.center);
      ...
      var promise = external_Cesium_.sampleTerrainMostDetailed(terrain, positions);
      // @ts-ignore
      external_Cesium_.when(promise, function (updatedPositions) {
        var _a, _b, _c;
        var longitude = options.longitude,
          latitude = options.latitude;
        var terrainHeight = updatedPositions[0].height;
        if (options.height && options.height > 0) {
          // 这里使用options.height没有错, 判断有没有传入height属性
          terrainHeight = options.height; // 这里使用o.height也没有错，使用处理后的高度
        }

        tileset.coordinate.push(terrainHeight); // 保存模型的高度
        //跳转到设定的经纬度，地形高度
        tileset._root.transform = external_Cesium_.Transforms.eastNorthUpToFixedFrame(external_Cesium_.Cartesian3.fromDegrees(longitude, latitude, 0));
        _this.viewer.scene.primitives.add(tileset);
        //处理当前3D模型的偏移
        var cartographic = external_Cesium_.Cartographic.fromCartesian(tileset.boundingSphere.center); //获取到倾斜数据中心点的经纬度坐标（弧度）
        var surface = external_Cesium_.Cartesian3.fromRadians(cartographic.longitude, cartographic.latitude, cartographic.height);
        var position = external_Cesium_.Cartesian3.fromDegrees(longitude, latitude, terrainHeight); //正确位置
        var translation = external_Cesium_.Cartesian3.subtract(position, surface, new external_Cesium_.Cartesian3()); //偏移的多少
        tileset.modelMatrix = external_Cesium_.Matrix4.fromTranslation(translation); //完成偏移
        tileset.m = external_Cesium_.Matrix4.fromTranslation(translation); //保存模型缩放等级为1的矩阵
        tileset.originPosition = external_Cesium_.Matrix4.fromTranslation(translation); //保存模型的原始矩阵
        // 缩放
        var m1 = external_Cesium_.Matrix3.fromScale(new external_Cesium_.Cartesian3(options.scale, options.scale, options.scale));
        // 再次变换矩阵
        _this.translate(tileset, m1, tileset.modelMatrix);
        // 设置旋转角度
        _this.rotate((_a = options.rotation) === null || _a === void 0 ? void 0 : _a.x, (_b = options.rotation) === null || _b === void 0 ? void 0 : _b.y, (_c = options.rotation) === null || _c === void 0 ? void 0 : _c.z, options.scale, tileset);
        var bcenter = JSON.stringify(tileset.boundingSphere.center);
        tileset.originParams.boundingSphereCenter = JSON.parse(bcenter);
        tileset.originParams.modelMatrix = external_Cesium_.Matrix4.clone(tileset.modelMatrix);
      });
  ...
  Cesium3DTiles.prototype.translate = function (tileset, transform, matrix) {
    var m = external_Cesium_.Matrix4.clone(matrix);
    var transformMat = external_Cesium_.Matrix4.fromArray(m);
    var matRotation = external_Cesium_.Matrix4.getMatrix3(transformMat, new external_Cesium_.Matrix3());
    var inverseMatRotation = external_Cesium_.Matrix3.inverse(matRotation, new external_Cesium_.Matrix3());
    var matTranslation = external_Cesium_.Matrix4.getTranslation(transformMat, new external_Cesium_.Cartesian3());
    var transformation = external_Cesium_.Transforms.eastNorthUpToFixedFrame(tileset.boundingSphere.center);
    var transformRotation = external_Cesium_.Matrix4.getMatrix3(transformation, new external_Cesium_.Matrix3());
    var transformTranslation = external_Cesium_.Matrix4.getTranslation(transformation, new external_Cesium_.Cartesian3());
    var matToTranslation = external_Cesium_.Cartesian3.subtract(matTranslation, transformTranslation, new external_Cesium_.Cartesian3());
    matToTranslation = external_Cesium_.Matrix4.fromTranslation(matToTranslation, new external_Cesium_.Matrix4());
    var matToTransformation = external_Cesium_.Matrix3.multiply(inverseMatRotation, transformRotation, new external_Cesium_.Matrix3());
    matToTransformation = external_Cesium_.Matrix3.inverse(matToTransformation, new external_Cesium_.Matrix3());
    matToTransformation = external_Cesium_.Matrix4.fromRotationTranslation(matToTransformation);
    var rotationTranslation = external_Cesium_.Matrix4.fromRotationTranslation(transform);
    external_Cesium_.Matrix4.multiply(transformation, rotationTranslation, transformation);
    external_Cesium_.Matrix4.multiply(transformation, matToTransformation, transformation);
    external_Cesium_.Matrix4.multiply(transformation, matToTranslation, transformation);
    tileset.modelMatrix = transformation;
  };
  Cesium3DTiles.prototype.rotate = function (x, y, z, scale, tileset) {
    var anglex = external_Cesium_.Matrix3.fromRotationX(external_Cesium_.Math.toRadians(x));
    var angley = external_Cesium_.Matrix3.fromRotationY(external_Cesium_.Math.toRadians(y));
    var anglez = external_Cesium_.Matrix3.fromRotationZ(external_Cesium_.Math.toRadians(z));
    var m1 = external_Cesium_.Matrix3.fromScale(new external_Cesium_.Cartesian3(scale, scale, scale));
    external_Cesium_.Matrix3.multiply(angley, anglez, angley);
    external_Cesium_.Matrix3.multiply(anglex, angley, anglex);
    external_Cesium_.Matrix3.multiply(anglex, anglez, anglex);
    external_Cesium_.Matrix3.multiply(anglex, m1, anglex);
    this.translate(tileset, anglex, tileset.m);
  };
  return Cesium3DTiles;
}();
/* harmony default export */ var Cesium3dTiles = (Cesium3DTiles);
